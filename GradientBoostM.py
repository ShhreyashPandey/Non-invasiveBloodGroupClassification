...
if data['training_data'].shape[0] == 0 or data['training_labels'].shape[0] == 0:
    ...
    gb_grid = GridSearchCV(gb_model, gb_param_grid, cv=5, verbose=1)
    gb_grid.fit(data['training_data'], data['training_labels'])
    ...
    y_pred_gb = gb_grid.predict(data['validation_data'])
    ...
    for blood_group in blood_group_labels:
        ...
        y_pred_gb_blood_group = gb_grid.predict(validation_data_blood_group)
    ...
    save_path = r"C:\Users\shhre\OneDrive\Desktop\SML\gbm_model.pkl"
    with open(save_path, 'wb') as f:
        pickle.dump(gb_model, f)

    print("Gradient Boosting model saved successfully as")